...
Usage:
    ros2 run <package_name> bluerov2_pid_disp_xyyaw_control

To run with custom parameters:
    ros2 run <package_name> bluerov2_pid_disp_xyyaw_control --ros-args -p model_name:=my_rov -p pos_Kp:=5.0 -p pos_Ki:=0.005 -p yaw_Kp:=1.0 -p req_disp_x:=3.0 -p req_disp_y:=5.0
